...
.calculator .calculator-border .calculator-display{
  ...
  -webkit-box-shadow: 1rem 1rem 0.5rem #6fac81;
  box-shadow: 0.1rem 0.1rem 0.5rem #92ac94;
}
...
.calculator .calculator-border .calculator-items .calculator-item{
  border: 0.1rem solid rgba(158, 144, 144, 0.74);
  width: 16.666%;
  height: 4rem;
  ...
  background-color: rgba(191, 189, 207, 0.78);
...
.calculator .calculator-border .calculator-items .calculator-item:hover{
  color: #f1f5f7;
  -webkit-box-shadow: 0.3rem 0.3rem 0.5rem #b88787;
  box-shadow: 0.3rem 0.3rem 0.5rem #81ac88;
